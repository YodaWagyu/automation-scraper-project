...
print(f"✅ Daily file saved: {daily_filename}")

# --- EXPORT MASTER FILE WITH SIZE/PACK ---
...
master_df.to_excel("Product_Master_BigC.xlsx", index=False)
print("✅ Master file saved: Product_Master_BigC.xlsx")
